    ...
    sendBody = await Promise.race<boolean>([
      ...
      new Promise((resolve) => {
        httpRequest.on("continue", () => {
          ...
          console.log("Smithy Debug Log: writeRequestBody - Received continue event, sending body");
          resolve(true);
        });
        httpRequest.on("response", () => {
          ...
          timing.clearTimeout(timeoutId);
          console.log("Smithy Debug Log: writeRequestBody - Received response event, not sending body");
          resolve(false);
        });
        httpRequest.on("error", () => {
          ...
          console.log("Smithy Debug Log: writeRequestBody - Received error event, not sending body");
          resolve(false);
        });
      }),
    ]);
